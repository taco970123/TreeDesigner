...
namespace TreeDesigner.Editor
{
    ...
    public class TreeInspectorEditor : UnityEditor.Editor
    {
        protected TreeInspectorView treeInspectorView;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            treeInspectorView.Init(target as BaseTree, false);
        ...
        public override void OnInspectorGUI()
        {
            ...
            while (serializedProperty.NextVisible(false))
            {
                ...
                if (ReadOnly(serializedProperty))
                    GUI.enabled = false;
